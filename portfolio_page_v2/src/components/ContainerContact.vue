<template>
  <div id="ContainerContact" class="container columns full">
    <div>
    ...
    <div class="wrapper">
      <div class="inner">
        <div>
          <h2 id="text09" class="style1">Contact</h2>
        </div>
        <div>
          <ul id="buttons01" class="style1 buttons">
            <li><a href="https://www.linkedin.com/in/michael-mente-b0739a143/"
                   class="button n01">
              <svg>
                <use xlink:href="#icon-90b"></use>
              </svg>
              <span class="label">LinkedIn</span></a></li>
            <li><a href="https://github.com/whiskeywolke" class="button n02">
              <svg>
                <use xlink:href="#icon-907"></use>
              </svg>
              <span class="label">GitHub</span></a></li>
            <li><a href="mailto:getintouchwithmichaelmente@proton.me" class="button n03">
              <svg>
